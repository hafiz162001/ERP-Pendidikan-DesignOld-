...
$("#id_pilih").change(function() {
            ...
            if ($("#id_pilih option:selected").val() == '2') {
                ...
                $('#id_course').prop('required', false);
                $('#id_learning').prop('required', true);
            } else {
                $('#learning').prop('hidden', true);
                $('#course').prop('hidden', false);
                $('#id_course').prop('required', true);
                $('#id_learning').prop('required', false);
            }
        });
});
</script>
        ...
        <div class="col-lg-8">
            ...
            <div class="card mb-2">
                <div class="card-header py-3" style="margin-bottom:-21px">
                    <h4 class="font-weight-bold text-primary"><i class="fas fa-plus"></i> Tambah Kupon</h4>
                    <!-- <h6 style="font-size:14px">Ubah Kolom Kota dibawah</h6> -->
                </div>
                <div class="card-body">
                    <?= form_open_multipart('dapur/transaksi/store_coupon'); ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" aria-describedby="nama_kupon" placeholder="Nama Kupon" name='nama' required autocomplete="off">
                    </div>

                    <div class="form-group">
                        <label for="deskripsi">Deskripsi<span>
                                <font color="red">*</font></label>
                        <textarea type="text" class="form-control" aria-describedby="deskripsi" placeholder="Deskripsi" name='deskripsi' id="deskripsi"></textarea>
                    ...
                    <div class="row" id="pilih" hidden="true">
                        <div class="col-md-6">
                            <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="form-group" id="course">
                                <label for="course">Course<span>
                                        <font color="red">*</font></span></label><br>
                        ...
                        <div class='col-md-6'>
                            <div class="form-group">
                                <label for="date">Expired Date<span>
                                        <font color="red">*</font></label>
                                <input type="text" class="form-control" aria-describedby="date" style='background:#fafafa' placeholder="Klik disini..." name='date' id="date_start" required>
