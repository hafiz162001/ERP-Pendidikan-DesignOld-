    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card mb-4 rounded-lg" style="opacity: 0.8;">
                    <div class="card-header py-3" style="margin-bottom:-21px">
                        <a class="btn btn-secondary float-right" href="<?= base_url('dapur/transaksi/coupon') ?>" title="data yang masih aktif di simpan disini"><i class="fas fa-th-list"></i><br>Halaman<br>Utama</a>
                        <h4 class="font-weight-bold text-primary"><i class="fas fa-history"></i> History Data Kupon</h4>
                        <h6 style="font-size:14px" class="font-italic">history data kupon keseluruhan </h6>
                    </div>
                    <div class="table-responsive">
                        <div class="card-body">

                            <!-- SEARCH -->
                            <?= form_open('dapur/transaksi/trash_kupon', array('method'=>'get')); ?>
                            <div class='row'>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <form action="<?= base_url('dapur/transaksi/action_kupon/') ?>" method="POST">
                                                    ...
                                                    <!-- EDIT, HAPUS-->
                                                    <button class="btn btn-success btn-sm" name="action" value="restore" onclick="return confirm('Apakah anda yakin, ingin me-restore data ini?')"><i class="fas fa-trash-restore"></i></button>
                                                    <!-- /EDIT, HAPUS -->
