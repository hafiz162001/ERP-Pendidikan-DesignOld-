        ...
        <div class="container">
            <div class="row">
                <?php foreach ($server as $key => $value) : ?>
                    <?php if ($value->jenis_server == 1) { ?>
                        <div class="col-md-4 col-sm-6">
                            <div class="product-item">
                                <div class="product-item-img">
                                    <a href="DateCPU/<?php echo $value->id_server ?>" id="<?php echo $value->id_server?>"><img src="<?php echo base_url() ?>assets/img/CPU.png" /></a>
                                </div>
