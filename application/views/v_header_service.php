					...
					<div class="menu">
						<nav id="main-menu" class="main-menu">
							<ul>
								...
								<!--<li><a href="https://bisa.ai/Dashboard/elearning">E-Learning</a></li>-->
								<li>
							        <div class="dropdown ">
								...
								<li><a data-toggle="modal" data-target="" href="https://bisa.ai/Dashboard/HistoryService">History Service</a></li>
