    ...
    <div class="container" >
        <div class="row">
            <div class="col mt-5 mb-1">
                <h3> <i class="fa fa-book" aria-hidden="true"></i> Sertifikat Saya</h3>
            </div>
        </div>
        <div class="row">
...
$(document).ready(function(){
    ...
    function showTransaksi(){
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo base_url(); ?>cert/showhistory', 
            dataType : "JSON",
            data:{
            ...
            success: function(data){ 
                ...
                $.each(data.data, function(i, item) {
                    ...
                    html += '<div style="cursor: pointer; " class="col-md-4 col-sm-12 col-12 mb-2" >';
                    ...
                    html += '<p><a href="<?php echo $this->CI->config->item('bisaUrl');?>master_sertifikat/media/course/'+item.id_course+'/'+item.foto_sertifikat+'" class="btn btn-success btn-block" target="_blank"> Download </a> </p>';
                    html += '<p class="align-self-end float-right" style="color: orange; font-weight: bold;margin-top: auto;"> <i class="fa fa-copyright" aria-hidden="true"></i> '+item.point+' Pts</p>';
                    html += '</div>';
                    html += '</div>';
                    html += '</div>';
                });
