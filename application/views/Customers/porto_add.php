                    ...
                    <div class="row">
                        <div class="col">
                            <div id="" style="margin: auto; width:100%; max-width: 200px">
                                <img class="rounded" id="imgprev1" src="<?=base_url()."assets/images/blankdoc.jpg";?>" style="width: 100%;"> 
                            </div>

                            <div class="form-group mt-3">
                                <label for="file">Tambah Foto Project (max 2Mb)</label>
                        ...
                        <div class="col">
                            <div id="" style="margin: auto; width:100%; max-width: 200px">
                                <img class="rounded" id="imgprev2" src="<?=base_url()."assets/images/blankdoc.jpg";?>" alt="" style="width: 100%;"> 
                            </div>
                        ...
                        <div class="col">
                            <div id="" style="margin: auto; width:100%; max-width: 200px">
                                <img class="rounded" id="imgprev3" src="<?=base_url()."assets/images/blankdoc.jpg";?>" alt="" style="width: 100%;"> 
                            </div>
        ...
        <div class="card shadow box-shadow">
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="" id="nama" aria-describedby="helpId" placeholder="Portofolio" maxlength="50">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" name="" id="id_course">
                      <?php foreach ($course['data'] as $key => $val) {
                          echo "<option value='".$val['id_customer_course']."'>".$val['nama_course']."</option>";
                      }?>
                ...
                <div class="">
                    <div id="" style="margin: auto; width:100%; max-width: 200px">
                        <img class="rounded" id="imgprev4" src="<?=base_url()."assets/images/blankdoc.jpg";?>" alt="" style="width: 100%;"> 
                    </div>
...
$(document).ready(function() {
    ...
    function saveData(){
        if (img_porto == "") {
            Msg("Mohon masukkan foto portofolio", "alert-danger");
            return false;
        }

        $.ajax({
            type: 'POST',
            url: '<?php echo base_url(); ?>portofolioku/save', 
            dataType : "JSON",
            data: {
            ...
            success: function(data){ 
                ...
                if (data.status_code == 200) {
                    Msg("Berhasil menambahkan portofolio", "alert-success");
                    $("#saveErr").hide();

                    setTimeout(() => {
                        window.location.href = "<?=base_url()?>portofolioku";  
                    }, 1000);
                } else {
