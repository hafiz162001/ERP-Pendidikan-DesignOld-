...
<head>
  ...
  <title>Login admin Bisa.Ai</title>
        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            <div class="login-brand">
              <a href="https://bisa.ai/"><img src="<?php echo base_url()?>assets/img/logo-bisa.png" alt="logo" width="100" ></a>
            </div>
            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                <form method="POST" action="<?php echo base_url('Login/ceklogintest');?>" class="needs-validation" novalidate="">
                  ...
                  <div class="form-group">
                    <button type="submit" id="log" class="btn btn-primary btn-lg btn-block" tabindex="4">
                      Login
                    </button>
                  </div>
                </form>
