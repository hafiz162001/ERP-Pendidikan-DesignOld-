...
?>
<section class="container-fluid my-5 py-5" style="background: rgb(20,101,50);
background: linear-gradient(148deg, rgba(20,101,50,1) 0%, rgba(53,165,95,1) 100%); color: white; height: auto"> 
    <div class="container p-4">
        <div class="row">
            <div class="col-md-7 col-sm-12">
                <h2><?=$data['data'][0]['nama_degree'];?></h2>
                <div style="color: white;">
                  Jenjang pendidikan: <?=$data['data'][0]['nama_jenjang_pendidikan'];?>, Program studi <?=$data['data'][0]['nama_program_studi'];?> <?=$data['data'][0]['nama_universitas'];?> 
                </div>
                <div class="mt-2">
                </div>
                <div class="mt-5">
        ...
        <div class="row mb-4">
            ...
            <div class="card" style="width: 100%;">
                <div class="card-header">
                    ...
                    <li class="nav-item">
                        <a class="nav-x nav-link" href="#showData" id="btnAbout">About the University</a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="card-body" >
                    ...
                    <div id="cRegis" class="containerData" style="display: none;">
                      ...
                      <!-- <form>
                        ...
                        <hr>
                        <div class="form-group row">
                          <label for="" class="col-sm-4 col-form-label">Nama sesuai identitas</label>
                          <div class="col-sm-8">
                            <input type="text" class="form-control" id="" value="" placeholder="Nama lengkap identitas">
                          </div>
                        </div>
                        ...
                        <div class="form-group row">
                          <label for="" class="col-sm-4 col-form-label">Nama sesuai ijazah</label>
                          <div class="col-sm-8">
                            <input type="text" class="form-control" id="" value="" placeholder="Nama lengkap ijazah">
                          </div>
                        </div>
                        ...
                        <div class="form-group row">
                          <label for="" class="col-sm-4 col-form-label">Nomor identitas</label>
                          <div class="col-sm-8">
                            <input type="text" class="form-control" id="" value="" placeholder="Nomor identitas sesuai nik/passport/sim">
                          </div>
                        </div>
                        ...
                        <div class="form-group row">
                          <label for="" class="col-sm-4 col-form-label">Alamat tetap</label>
                          <div class="col-sm-8">
                            <input type="text" class="form-control" id="" value="" placeholder="Alamat tetap">
                          </div>
                        </div>
                        ...
                        <div class="form-group row">
                          <label for="" class="col-sm-4 col-form-label">Kabupaten / Kotamadya</label>
                          <div class="col-sm-8">
                          <select class="form-control">
                            <option>-- pilih --</option>
                        ...
                        <div class="form-group row">
                          <label for="" class="col-sm-4 col-form-label">Alamat saat ini / domisili</label>
                          <div class="col-sm-8">
                            <input type="text" class="form-control" id="" value="" placeholder="Alamat saat ini">
                          </div>
                        </div>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-8">
                            <input type="text" class="form-control" id="" value="" placeholder="Nomor telepon yang dapat dihubungi. Pisahkan dengan , (koma) jika ada beberapa nomor.">
                          </div>
                        </div>

                        <div class="form-group row">
                          <label for="" class="col-sm-4 col-form-label">No. H.P. (opsional)</label>
                          <div class="col-sm-8">
                            <input type="text" class="form-control" id="" value="" placeholder="Nomor handphone (jika ada). Pisahkan dengan , (koma) jika ada beberapa nomor.">
                          </div>
                        </div>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-8">
                            <input type="text" class="form-control" id="" value="" placeholder="Pastikan alamat email Anda benar, email konfirmasi akan dikirim ke alamat email tersebut">
                          </div>
                        </div>

                        <div class="form-group row">
                          <label for="" class="col-sm-4 col-form-label">Ulangi Email </label>
                          <div class="col-sm-8">
                            <input type="text" class="form-control" id="" value="" placeholder="Pastikan alamat email Anda benar">
                          </div>
                        </div>
                        ...
                        <div class="form-group row">
                          <label for="" class="col-sm-4 col-form-label"> </label>
                          <div class="col-sm-8">
                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalBayar"> Submit </button>
                          </div>
                        </div>
                      </form> -->
                    </div>
