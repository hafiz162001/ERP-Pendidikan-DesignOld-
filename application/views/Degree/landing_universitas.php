            ...
            <div class="col-md-3 col-sm-12">
                <div class="form-group">
                    <select class="form-control" name="univ" id="univ">
                        <option value="" selected>==Semua institusi pendidikan==</option>
        ...
        $.ajax({
            ...
            success: function(data){ 
                ...
                $.each(data.data, function(i, item) {
                    html += '<div class="card shadow box-shadow pointer mb-2" onclick=goto("<?=base_url();?>degree/detail_university/'+item.id_dgr_degree+'") >';
