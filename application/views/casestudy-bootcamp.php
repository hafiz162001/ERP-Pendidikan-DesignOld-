...
<head>
    ...
    <title>Case Study - Bootcamp</title>
</head>
...
<body>
        ...
        <div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="img-fluid" src="<?= base_url() ?>assets/img/case/bootcamp1.jpg" style="filter:blur(4px) brightness(70%); object-fit:cover; height:620px; width:100%;">
                    <div class="carousel-caption  position-absolute text-light" style="margin-bottom:180px !important;">
                        <h2 class="poppins-600 letter-spacing">Platform Bootcamp Daring Yang Praktis dan Terpadu</h2>
                        <p class="text-size-5 poppins-400 letter-spacing">Belajar dengan lebih serius dan terpadu lewat Bootcamp di BISA AI Academy</p>
    ...
    <section>
        <div class="container">
            <div class="row mt-5 text-center">
                <div class="col">
                    <h3 class="letter-spacing poppins-600">Belajar Lebih Terpadu</h3>
                    <p class="text-muted poppins-400" style="line-height:1.9">
                        Asah terus keahlianmu dengan aplikasi BISA AI Academy
                    </p>
    ...
    <section class="my-5">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <img src="<?= base_url('assets/img/case/bootcamp2.jpg') ?>" alt="" class="mx-auto d-block img-fluid" style="width:475px; height:526px; object-fit:cover; filter:brightness(80%);">
                </div>
                <div class="col-lg-6">
                    <img src="<?= base_url('assets/img/case/bootcamp3.jpg') ?>" alt="" class="my-3 mx-auto d-block img-fluid" style="width:517px; height:290px; object-fit:cover; filter:brightness(80%)" class="float-left mb-3">
                    <h3 class="poppins-600 letter-spacing text-hitam-custom pl-3">
                        Silabus dan Kuis Komplit
                    </h3>
                    <p class="montserrat-400 mt-3 letter-spacing pl-3">
                        Setiap bootcamp di aplikasi BISA AI Academy memiliki silabus dan kuis yang bisa diakses langsung lewat aplikasi BISA AI Academy.
                    </p>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row mb-5">
            <div class="col-lg-6 text-center">
                <img src="<?= base_url() ?>assets/img/case/bootcamp4.jpg" style="width:475px; height:283px; object-fit:cover; filter:brightness(70%)">
            </div>
            <div class="col-lg-6">
                <h3 class="poppins-600 letter-spacing text-hitam-custom">
                    Penjelasan dan Diskusi Daring Bersama Pemateri
                </h3>
                <p class="poppins-400 mt-3 letter-spacing">
                    Setelah belajar silabus-silabus yang diberikan, kalian bisa lebih memahami materi lebih lanjut lewat sesi diskusi daring bersama pemateri. Diskusi daring ini merupakan bagian utama dari Bootcamp daring BISA AI Academy.
                </p>
            </div>
        </div>
    </div>
                    ...
                    <div class="card h-100">
                        <div class="card-body">
                            <div class="text-center">
                                ...
                                <h6 class="card-title mt-3 poppins-600 letter-spacing">Materi Yang Terpadu</h6>
                                <p class="card-text poppins-400 text-muted">
                                    Dibuat oleh pemateri berpengalaman, materi bootcamp selalu dimulai dari pengenalan hingga studi kasus tingkat lanjut untuk memastikan peserta dapat memahami semua materi yang ada.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card h-100">
                        <div class="card-body">
                            <div class="text-center">
                                ...
                                <h6 class="card-title mt-3 poppins-600 letter-spacing">Bersertifikat</h6>
                                <p class="card-text poppins-400 text-muted">
                                    Dapatkan langsung sertifikat digital berstandar setelah menyelesaikan bootcamp di aplikasi BISA AI Academy
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card h-100">
                        <div class="card-body">
                            <div class="text-center">
                                ...
                                <h6 class="card-title mt-3 poppins-600 letter-spacing">Memadukan Industri dan Riset
                                </h6>
                                <p class="card-text poppins-400 text-muted">
                                    Berbagai bootcamp dan silabus di dalamnya selalu dapat dimanfaatkan untuk keperluan riset dan praktek di industri secara langsung.
                                </p>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row mb-5 mt-5">
                <div class="col-lg-12 text-center">
                    <h2 class="poppins-600 letter-spacing">Bootcamp Daring Terpadu dengan BISA AI Academy</h2>
