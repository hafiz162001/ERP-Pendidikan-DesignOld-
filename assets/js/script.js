...
var UrlPath = "https://gate.bisaai.id/elearning/learning_path/media/";
...
function UrlMedia(str) {
    return "https://gate.bisaai.id/elearning/" + str + "/media/";
}
...
function LoadingButton(type, text, name = 'save') {
    ...
    if (type == 'on') {
        $(button).html("<i class='fa fa-circle-o-notch fa-spin' style='font-size:24px'></i> " + text)
